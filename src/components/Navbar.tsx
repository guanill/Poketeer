              ...
              {authMode === 'pick' ? (
                <div className="p-3 space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-xs font-bold bg-white text-gray-800 hover:bg-gray-100 transition-colors"
                  >
